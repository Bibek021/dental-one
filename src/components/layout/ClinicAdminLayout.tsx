// Clinic Admin layout with sidebar navigation
...
export function ClinicAdminLayout({ isDoctorMode = false }: ClinicAdminLayoutProps) {
  ...
  const adminNavigationItems: NavItem[] = [
    ...
    // Only show staff management for admins, not doctors
    ...(!isDoctorMode ? [{
      id: 'staff',
    ...
    // Only show clinic settings for admins, not doctors
    ...(!isDoctorMode ? [{
      id: 'settings',
  ...
  // Navigation items for doctor mode (limited access)
  ...
  const navigationItems = isDoctorMode ? doctorNavigationItems : adminNavigationItems;
